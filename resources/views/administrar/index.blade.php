...
<div class="text-center">
    ...
    <video src="img/restaurant.mp4" class="object-fit-scale" width="75%" autoplay controls muted
                ...
                <div class="col">
                    <div class="d-flex">
                        ...
                        <div class="border p-3">
                            <p class="mb-0"><strong>{{ $comentario->nombre }}:</strong>{{ $comentario->comentario }}
                            </p>
                            <br>
